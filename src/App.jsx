...
import ProposalReviewPage from "./pages/client/ProposalReviewPage"; // ADDED import
    ...
    <SocketProvider>
      <Router>
        ...
        <Routes>
          ...
          {/* ADDED */}
          <Route
            path="/project/collaborate/:projectId"
          ...
          <Route
            path="/client/proposal-review/:projectId"
