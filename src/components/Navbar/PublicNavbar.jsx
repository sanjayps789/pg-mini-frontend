  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <Link
          to="/"
          className="flex items-center text-xl sm:text-2xl font-bold text-indigo-600"
        >
      ...
      {isOpen && (
        <div className="md:hidden px-6 pt-2 pb-4 border-t border-gray-200">
          <Link
            to="/login"
            className="block mt-2 bg-indigo-600 text-white text-center font-semibold py-2 px-4 rounded-lg hover:bg-indigo-700"
          >
            Login
          </Link>
          <Link
